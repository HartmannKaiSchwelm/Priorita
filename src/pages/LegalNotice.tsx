...
export default function LegalNotice() {
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4">
            ...
            <h2 className="text-2xl font-bold text-primary mb-4">3. VAT ID</h2>
            <p className="text-light mb-6">VAT identification number according to § 27 a of the German VAT law: DE123456789</p>
            
            <h2 className="text-2xl font-bold text-primary mb-4">4. Responsible for content according to § 55 para. 2 RStV</h2>
            <p className="text-light mb-2">Kai Hartmann</p>
            <p className="text-light mb-2">Kolpingstr. 4</p>
            <p className="text-light mb-2">58332 Schwelm</p>
            <p className="text-light mb-6">Germany</p>
            
            <h2 className="text-2xl font-bold text-primary mb-4">5. Liability for Content</h2>
            ...
            <h2 className="text-2xl font-bold text-primary mb-4">6. Liability for Links</h2>
            <p className="text-light mb-6">
            ...
            <h2 className="text-2xl font-bold text-primary mb-4">7. Copyright</h2>
            <p className="text-light mb-6">
